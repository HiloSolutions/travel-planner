...
import defaultLocationImage from '../../images/location.png';
...
const EditLocation = ({
  ...
  const displayPicture = location.location_image || defaultLocationImage;
    ...
    >
      <DialogContent>
        ...
        <div className="image-container">
          <img src={displayPicture} alt="Cover" />
          <EditPictureButton
            location={location}
            initialPicture={displayPicture}
